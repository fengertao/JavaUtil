            ...
            for (int i2 = 0; i2 < 9; i2++) {
                ...
                for (int i3 = 0; i3 < 9; i3++) {
                    ...
                    for (int i4 = 0; i4 < 9; i4++) {
                        ...
                        for (int k = 0; k < 9; k++) {
                            if (cells[i1].candidates[k].getValue()) {
                                supportNumberSet.add(k + 1);
                                continue;
                            }
                            if (cells[i2].candidates[k].getValue()) {
                                supportNumberSet.add(k + 1);
                                continue;
                            }
                            if (cells[i3].candidates[k].getValue()) {
                                supportNumberSet.add(k + 1);
                                continue;
                            }
                            if (cells[i4].candidates[k].getValue()) {
                                supportNumberSet.add(k + 1);
                                continue;
                            }
                        }
